        ...
        website : [
             {
                ...
                imageURL : "../assets/images/web (1).png",
            ...
            },
            {
                ...
                imageURL : "../assets/images/web (4).png",
            ...
            },
            {
                ...
                imageURL : "../assets/images/web (3).png",
                stack : "VUE.js | Firebase",
            ...
            },
            {
                ...
                imageURL : "../assets/images/web (2).png",
        ...
        logo : [
            {
                name : "Relate+ CRM",
                desc : 'A mini Customer Relationship Management Web App',
                imageURL : "../assets/images/logo (1).jpg",
                stack : "CorelDraw",
                link : "http://alawiye.netlify.app../assets/images/logo (1).jpg",
            },
            {
                name : "Havan FX",
                desc : 'A Forex Trading Company into Investment and Training',
                imageURL : "../assets/images/logo (4).jpg",
                stack : "CorelDraw",
                link : "http://alawiye.netlify.app../assets/images/logo (4).jpg",
            },
            {
                name : "Osun Aseyori",
                desc : 'A Tradomedical Center',
                imageURL : "../assets/images/logo (3).jpg",
                stack : "CorelDraw",
                link : "http://alawiye.netlify.app../assets/images/logo (3).jpg",
            },
            {
                name : "Luke Ink Notary",
                desc : 'a mini Customer Relationship Management Web App',
                imageURL : "../assets/images/logo (2).jpg",
                stack : "CorelDraw",
                link : "http://alawiye.netlify.app../assets/images/logo (2).jpg",
            },
        ],
        flyer : [
            {
                ...
                imageURL : "../assets/images/flyer (1).png",
                stack : "CorelDraw",
                link : "../assets/images/flyer (1).png",
            },
            {
                name : "Siaat Cakes Training",
                desc : 'Ballon Class Training organized by Siaat Cakes and Party Planning',
                imageURL : "../assets/images/flyer (2).jpg",
                stack : "CorelDraw",
                link : "../assets/images/flyer (2).jpg",
            },
            {
                name : "Ribdex Property",
                desc : 'A property showcasing flyer',
                imageURL : "../assets/images/flyer (3).jpg",
                stack : "CorelDraw",
                link : "../assets/images/flyer (3).jpg",
            },
        ],
    }
};
